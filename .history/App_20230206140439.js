...
function render(arr) {
  ...
  if (arrTodo.length === (pagesCount * rows)) {
...
function test2(event) { // отрисовывам по 5 элементов
  // if (buttonPagination.classList.contains('button-pagination')) {
  // }
  console.log(event.target.classList.contains('button-pagination'));
}
