...
function render(arr) {
  console.log(buttonFilter.classList.contains('button-filter-on'));
  console.log(buttonFilter.classList.contains('button-all'));
  console.log(buttonFilter.classList.contains('button-active'));
  // test();
  let displayMessage = '';
  arr.forEach((item) => {
...
function test() {
  let arrFilter = [];
  switch (buttonFilter.classList.('button-filter-on')) {
    case buttonAll.classList.contains('button-all'):
      render(arrTodo);
      break;
    case buttonCompleted.classList.contains('button-active'):
      arrFilter = arrTodo.filter((item) => item.checked !== true);
      render(arrFilter);
      break;
    case buttonCompleted.classList.contains('button-completed'):
      arrFilter = arrTodo.filter((item) => item.checked === true);
      render(arrFilter);
      break;
    default:
