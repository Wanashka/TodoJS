...
function pagination(page) { // отрисовывам по 5 элементов
  ...
  // console.log(paginatedArr.length);
...
function pagePagination(event) {
  const buttonPagination = paginationAllButton.contains('.button-pagination');
  console.log(event.target);
}

paginationAllButton.addEventListener('click', pagePagination);
